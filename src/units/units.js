...
function coinSoundClick(){
  Laya.SoundManager.playSound("sound/coin.mp3",1); 
}
function lunckySound(){
  Laya.SoundManager.playSound("sound/sound1.mp3",1); 
}
function jewelSound(){
  Laya.SoundManager.playSound("sound/diamond.mp3",1); 
}
