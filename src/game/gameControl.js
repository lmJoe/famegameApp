...
import { createText,getCookie,setCookie,playSoundClick, getCaption, clearCookie, getQueryVariable} from "../units/units.js";
//调优化代码文件
      ...
      ajax({
        ...
        success:(fameMsg)=>{
          ...
          if(fameMsg.code==1){
            ...
            this.createHeadImgMask(fameMsg.data.headImg)
