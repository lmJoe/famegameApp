    ...
    onEnable() {
      ...
      switch(this.stepNum){
        ...
        case 3:
          ...
          this.alertBg.skin = 'comp/icon24.png';
          this.alertBox.pos(this._param.content.x-187,this._param.content.y-89);
          this.alertBg.getChildByName("alertMsg").text = '花费金币,给种子浇水';
        ...
        case 4:
          ...
          this.alertBg.getChildByName("alertMsg").text = '点击矿洞，领取金币';
        ...
        case 6:
          ...
          this.alertBg.getChildByName("alertMsg").text = '花金币购买你的第二位员工';
          break;
      }
